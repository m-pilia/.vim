...
vmap <silent> <buffer> ib <plug>(mediawiki-text-object-inside-template-begin)
vmap <silent> <buffer> ab <plug>(mediawiki-text-object-around-template-begin)
omap <silent> <buffer> ib <plug>(mediawiki-text-object-inside-template-begin)
omap <silent> <buffer> ab <plug>(mediawiki-text-object-around-template-begin)

vmap <silent> <buffer> ie <plug>(mediawiki-text-object-inside-template-end)
vmap <silent> <buffer> ae <plug>(mediawiki-text-object-around-template-end)
omap <silent> <buffer> ie <plug>(mediawiki-text-object-inside-template-end)
omap <silent> <buffer> ae <plug>(mediawiki-text-object-around-template-end)
